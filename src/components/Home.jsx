  ...
  return (
    <>
      <Helmet>
        ...
        {/* ✅ Preload font for faster LCP render */}
        <link
          rel="preload"
        ...
        {/* ✅ Preload LCP element - the heading */}
        <link
          rel="preload"
          as="image"
          href="/images/1.webp"
      ...
      >
        <div className="max-w-3xl flex flex-col items-center justify-center min-h-[60vh]">
          {/* ✅ Added min-h-[60vh] and flex centering to improve vertical alignment and visual consistency */}
